    ...
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            (CONPTY.CreatePseudoConsole)(
                ...
                // Skylight opens a fresh terminal surface, so there is no
                // parent cursor to inherit. Requesting it blocks ConPTY
                // startup/resize until an asynchronous renderer replies.
